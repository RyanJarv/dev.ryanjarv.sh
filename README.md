...
This repository provides all the tooling to manage the `dev` account infrastructure on AWS. It distributes a single docker container which bundles the entire tool-chain and infrastructure as code necessary to administer the account.

## Acount Details

| Property       | Value                                                                                                                         |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| AWS Account ID | 253528964770                                                                                                             |
| Account Email  | ops+dev@ryanjarv.sh                                                                                                      |
| Login URL      | <https://signin.aws.amazon.com/switchrole?account=253528964770&roleName=OrganizationAccountAccessRole&displayName=rjsh-dev-admin> |
| Namespace      | rjsh                                                                                                                  |
| Stage          | dev                                                                                                                      |
...
Here is the list of some of the tools we use to provision `dev.ryanjarv.sh` infrastructure in order to facilitate cloud fabrication and administration:
...
```bash
/usr/local/bin/dev.ryanjarv.sh
```

**NOTE (a):** You can just run `dev.ryanjarv.sh`, if your `PATH` contains `/usr/local/bin`
